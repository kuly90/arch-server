...
app.get('/send-email', (req,res) => {
    ...
    const INSERT_CUSTOMERS = `INSERT INTO customers(name, email, subject, message) VALUES('${name}', '${email}', '${subject}', '${message}')`;
    nodemailer.createTestAccount((err, acount) => {
        const htmlEmail = `
            <h4>Deaer ${name},</h4>
            <p>Thank you for have ideas for our Company. We will reply you as soon as.</p>
            <p>Best Regard !</p>
            <br/>
            <h4>ARCH VIETNAM Co. Ltd</h4>
            <p>https://arch-vietnam.vn</p>
            <p>address: Tầng 17, Danang Software Park
            Số 02 Quang Trung, quận Hải Châu, thành phố Đà Nẵng</p>            
        `
